...
//***PARAMETERS***//
//for the leaves
int numb_leaves = 85; //how many leaves I want
float starting_height = 70; //the height where the tree starts

//for the branches
float thick_starter = 20;//Size of the first cube
float linear_coeff = 0;
float distance_smoothing =3; //the branches at the extremity are big when the numbr is hight
...
class Tree {
  ...
  Tree() {
    //here generating new leaves
    for (int i = 0; i < numb_leaves; i++) {
      leaves.add(new Leaf());
    }
    //here creating new branches
